...
function getQualifyingMarketOrders() {
    let marketOrders = Game.market.getAllOrders().filter((o) => o.type === ORDER_BUY && o.price >= 0.85 * Memory.resourcePriceMap[o.resourceType]);
    global.qualifyingMarketOrders = {};
    Object.keys(Memory.resourcePriceMap).forEach((res) => {
